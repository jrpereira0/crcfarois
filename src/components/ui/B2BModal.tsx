  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div
          className="relative bg-white rounded-3xl shadow-2xl max-w-2xl w-full pointer-events-auto animate-scale-in overflow-hidden"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Close Button */}
          <button
            onClick={handleClose}
            className="absolute top-4 right-4 z-10 text-gray-400 hover:text-gray-600 transition-colors duration-200 bg-white/80 backdrop-blur-sm rounded-full p-2 hover:bg-white"
            aria-label="Fechar"
          >
            <X size={24} />
          </button>
          ...
          <div className="relative bg-gradient-to-br from-primary via-blue-600 to-primary p-8 pb-12">
          ...
          <div className="p-8 -mt-6">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 mb-6 border border-gray-100 shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                href="/cadastro"
                onClick={handleClose}
                className="flex-1 group relative bg-primary text-white py-4 px-6 rounded-2xl font-bold inline-flex items-center justify-center overflow-hidden transition-all duration-300 hover:bg-primary/90 hover:scale-105 transform shadow-lg hover:shadow-xl"
              >
              ...
              <button
                ...
                className="sm:w-auto px-8 py-4 rounded-2xl font-semibold text-gray-700 hover:text-gray-900 transition-all duration-300 hover:bg-gray-100 border-2 border-gray-200 hover:border-gray-300"
              >
                Continuar Navegando
              </button>
            </div>
