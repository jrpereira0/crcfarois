          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                A CRC Faróis está comprometida em proteger a privacidade e os
                dados pessoais de nossos clientes, parceiros e visitantes do
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li>Processar pedidos e fornecer produtos e serviços</li>
                <li>Comunicar sobre pedidos, entregas e suporte</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                acesso não autorizado, alteração, divulgação ou destruição. Isso
                inclui criptografia, controles de acesso e monitoramento regular
                de nossos sistemas.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                navegação. Os cookies são pequenos arquivos de texto armazenados
                em seu dispositivo que nos ajudam a entender como você usa nosso
                site e personalizar sua experiência.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                por e-mail ou através de um aviso em nosso site. A data da
